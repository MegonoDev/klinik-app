<nav class="hidden md:flex justify-end items-center bg-white p-4 shadow-md h-16 mx-2 rounded-md mt-1">
    {{-- <div>
    ...
    <div>
        <button id="dropdownNavbarButton" data-dropdown-toggle="dropdownNav" class="flex items-center text-sm font-medium text-gray-900 rounded-full hover:text-primary md:mr-0 focus:ring-4 focus:ring-gray-100" type="button">
            ...
            <img class="mr-2 w-8 h-8 rounded-full" src="https://images.unsplash.com/photo-1472099645785-5658abf4ff4e?ixlib=rb-1.2.1&ixid=eyJhcHBfaWQiOjEyMDd9&auto=format&fit=facearea&facepad=2&w=256&h=256&q=80" alt="user photo">
            {{Auth::user()->name }}
